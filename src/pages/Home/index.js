...
<div className="door-back">  <div className="ingredientsTitle"> Ingredients
{/* <a href="/ingredients">
    <span className="link"></span></a>   */}
    <div className ="logOutBox" style= {{marginTop:'20px'}}>
    <button className="logOutButton" onClick={LoggedOut}> <span style= {{color: "#FFAF68"}}> L</span>
                                            <span style= {{color: "#F6E683"}}> o</span>
                                            <span style= {{color: "#A484E9"}}> g</span>
                                            &nbsp; 
    ...
    <div className="fridgeShelves"><div className="shelfOne"> <div className="carrot"> <img style ={{objectFit: 'fill'}} src = {require('../Ingredients/images/carrot.png')} alt="carrot" /> </div>
